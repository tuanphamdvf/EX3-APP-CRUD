...
function renderProducttable(elementProduct, PRODUC_ITEM) {
    ...
    PRODUC_ITEM.forEach((item, index) => {
        ...
        elementProduct.innerHTML += `<div class="product--item ${focusElement}" id ="product__element__${item.id}">
        ...
        <div class="product--item--content">
            <div class="container--icon--product">
                ...
                <a onclick = "showPopupDelete(${item})" class="product--icon" id ="delete__product__icon" ><img src="/src/icon/delete.svg" alt="delete"></a>
            </div>
        </div>
    </div><div id = "delete__element"></div>`;
    });
}
{
    /* <div class="popup--delete">
                    <div class="dlproduct--wrapper">
                        <span class="content--delete">Cảnh báo! Bạn có chắc chắn muốn xoá sản phẩm !</span>
